...
#define MAVLINK_MESSAGE_CRCS {{400, 44, 32, 32, 0, 0, 0}}
#endif
...
typedef enum INA219_TYPE
{
   ...
   voltage_in=1, /* Voltage in volts, 0 if unknown | */
   current_in=2, /* Current in amperes, -1 if unknown | */
   power_in=3, /* power in watts, -1 if unknown | */
   voltage_out=4, /* Voltage in volts, 0 if unknown | */
   current_out=5, /* Current in amperes, -1 if unknown | */
   power_out=6, /* power in watts, -1 if unknown | */
...
# define MAVLINK_MESSAGE_NAMES {{ "ina219", 400 }}
