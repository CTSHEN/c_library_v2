...
typedef struct __mavlink_ina219_t {
 ...
 float voltageIn; /*< [volts] Voltage in volts*/
 float currentIn; /*< [amperes] Current in amperes*/
 float powerIn; /*< [watts] Power in watts*/
 float voltageOut; /*< [volts] Voltage in volts*/
 float currentOut; /*< [amperes] Current in amperes*/
 float powerOut; /*< [watts] Power in watts*/
}) mavlink_ina219_t;
...
#define MAVLINK_MSG_ID_ina219_CRC 44
#define MAVLINK_MSG_ID_400_CRC 44
 ...
 * @param voltageIn [volts] Voltage in volts
 * @param currentIn [amperes] Current in amperes
 * @param powerIn [watts] Power in watts
 * @param voltageOut [volts] Voltage in volts
 * @param currentOut [amperes] Current in amperes
 * @param powerOut [watts] Power in watts
